...
created: 2026-04-15
keywords: institutional capacity, operational resilience, control and autonomy
...
It runs three things: OPNsense as a virtual machine, a UniFi controller LXC for wireless management, and a network-services LXC that hosts the reverse proxy and the identity provider. [Episode 1](/infrastructure/zero-to-homelab/home-network-design/) covered why the firewall is virtualized and what that entails. The point here is different: this node exists because its power draw is low enough to justify keeping it permanently on, and its workload is stable enough that it rarely needs attention.
...
This is the same separation of concerns described in [Episode 1](/infrastructure/zero-to-homelab/home-network-design/), but at the hardware level.
